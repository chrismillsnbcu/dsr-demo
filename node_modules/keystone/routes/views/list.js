...
exports = module.exports = function(req, res) {
	...
	var renderView = function() {
	    ...
	    // Display only users created by this admin, super admin's can see all users.
	    if(req.list.path === 'users' && req.user.level === 2) {
	      var adminId = req.user._id;
	      query.find( { $or: [ { _id: adminId }, { createdBy: adminId } ] } )
	    }
